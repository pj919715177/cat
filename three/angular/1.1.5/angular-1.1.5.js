...
(function (M, T, p) {
  ...
  function Fa() {
    for (var b = ba.length, a; b; ) {
      b--;
      a = ba[b].charCodeAt(0);
      if (a == 57) return ba[b] = 'A',
      ba.join('');
      if (a == 90) ba[b] = '0';
       else return ba[b] = String.fromCharCode(a + 1),
      ba.join('')
    }
    ba.unshift('0');
    return ba.join('')
  ...
  function V(b, a) {
    ...
    ])  : ra(b) ? a = new Date(b.getTime())  : L(b) && (a = V(b, {
    })));
    return a
  }
  function pc(b, a) {
  ...
  function zb(b) {
    ...
    }, '$destroy'), Ab(b)), delete Ka[a], b[Ja] = p)
  }
  function ca(b, a, c) {
    var d = b[Ja],
    d = Ka[d || - 1];
    if (B(c)) d || (b[Ja] = d = ++wc, d = Ka[d] = {
    }),
    d[a] = c;
     else return d && d[a]
  }
  ...
  function eb(b, a) {
    if (a) for (var a = !a.nodeName && B(a.length) && !sa(a) ? a : [
      a
    ], c = 0; c < a.length; c++) b.push(a[c])
  }
  function Eb(b, a) {
  ...
  function Dc(b, a, c, d) {
    ...
    f.url = function (a, b) {
      if (a) {
        if (x != a) return x = a,
        d.history ? b ? m.replaceState(null, '', a)  : (m.pushState(null, '', a), W.attr('href', W.attr('href')))  :
        b ? j.replace(a)  : j.href = a,
        f
    ...
    f.cookies = function (a, b) {
      ...
      if (a) if (b === p) h.cookie = escape(a) + '=;path=' + $ + ';expires=Thu, 01 Jan 1970 00:00:00 GMT';
        ...
        if (h.cookie !== D) {
          ...
          j = e.indexOf('='),
          j > 0 && (a = unescape(e.substring(0, j)), G[a] === p && (G[a] = unescape(e.substring(j + 1))))
        }
        return G
      }
    };
  ...
  function Jb(b) {
    ...
    this.directive = function h(d, e) {
      E(d) ? (cb(e, 'directive'), a.hasOwnProperty(d) || (a[d] = [
      ], b.factory(d + c, [
        '$injector',
        '$exceptionHandler',
        function (b, c) {
      ...
      function (b, j, m, k, l, u, o, z, r) {
        ...
        function W(a, b, c, d) {
          function e(a, c, d, g) {
            ...
            u = o = 0;
            for (m = j.length; o < m; u++) i = z[u],
            c = j[o++],
            h = j[o++],
            c ? (c.scope ? (k = a.$new(L(c.scope)), w(i).data('$scope', k))  : k = a, (l = c.transclude) || !g && b ? c(h, k, i, d, function (b) {
              return function (c) {
                var d = a.$new();
                d.$$transcluded = !0;
          ...
          for (var j = [
          ], g, h, k, i = 0; i < a.length; i++) h = new ma,
          g = v(a[i], [
          ], h, d),
        ...
        function v(a, b, c, j) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              G(b, l, 'A', j);
              a = a.className;
              if (E(a) && a !== '') for (; h = e.exec(a); ) l = da(h[2]),
              G(b, l, 'C', j) && (c[l] = U(h[3])),
            ...
            case 8:
              try {
                if (h = d.exec(a.nodeValue)) l = da(h[1]),
                G(b, l, 'M', j) && (c[l] = U(h[2]))
              } catch (u) {
              }
          }
        ...
        function A(a, b, c, d, e) {
          function h(a, b) {
            if (a) a.require = s.require,
            z.push(a);
            if (b) b.require = s.require,
            ea.push(b)
          }
          function i(a, b) {
            var c,
            ...
            e = !1;
            if (E(a)) {
              for (; (c = a.charAt(0)) == '^' || c == '?'; ) a = a.substr(1),
              c == '^' && (d = 'inheritedData'),
              e = e || c == '?';
              c = b[d]('$' + a + 'Controller');
          ...
          for (var l = - Number.MAX_VALUE, z = [
          ], ea = [
          ], r = null, K = null, W = null, J = c.$$element = w(b), s, A, Y, G, P = d, q, na, t, B = 0, C = a.length; B < C; B++) {
            s = a[B];
            Y = p;
            if (l > s.priority) break;
            if (t = s.scope) O('isolated scope', K, s, J),
            L(t) && (x(J, 'ng-isolate-scope'), K = s),
            x(J, 'ng-scope'),
            r = r || s;
            A = s.name;
            if (t = s.controller) q = q || {
            },
            O('\'' + A + '\' controller', q[A], s, J),
            q[A] = s;
            if (t = s.transclude) O('transclusion', G, s, J),
            G = s,
            l = s.priority,
            t == 'element' ? (Y = w(b), J = c.$$element = w(T.createComment(' ' + A + ': ' + c[A] + ' ')), b = J[0], ja(e, w(Y[0]), b), P = y(Y, d, l))  : (Y = w(fb(b)).contents(), J.html(''), P = y(Y, d));
            ...
            if (s.templateUrl) O('template', W, s, J),
            W = s,
        ...
        ma.prototype = {
          ...
          $set: function (a, b, c, d) {
            ...
            if (hb(this.$$element[0]) === 'A' && a === 'href') q.setAttribute('href', b),
            e = q.href,
      ...
      this.$get = [
        ...
        function (c, d) {
          function e(e, h) {
            ...
            ]; k < u; ) (j = e.indexOf(b, k)) != - 1 && (m = e.indexOf(a, j + g)) != - 1 ? (k != j && l.push(e.substring(k, j)), l.push(k = c(o = e.substring(j + g, m))), k.exp = o, k = m + i, o = !0)  : (k != u && l.push(e.substring(k)), k = u);
            if (!(u = l.length)) l.push(''),
            u = 1;
            if (!h || o) return z.length = u,
            k = function (a) {
              try {
                for (var b = 0, c = u, j; b < c; b++) {
                  if (typeof (j = l[b]) == 'function') j = j(a),
    ...
    function Pc(b, a) {
      ...
      function k(a) {
        ...
        for (var d = '', e = a, f = !1; o < b.length; ) {
          var j = b.charAt(o);
          e += j;
          if (f) j == 'u' ? (j = b.substring(o + 1, o + 5), j.match(/[\da-f]{4}/i) || h('Invalid unicode escape [\\u' + j + ']'), o += 4, d += String.fromCharCode(parseInt(j, 16)))  : (f = Qc[j], d += f ? f : j),
          f = !1;
           else if (j == '\\') f = !0;
           else if (j == a) {
            o++;
    ...
    function Rc(b, a, c, d) {
      ...
      function u() {
        for (var a = f(), b = c(a.text), d = [
          ...
          var e = function (a, c, e) {
            for (var e = [
              e
            ], f = 0; f < d.length; f++) e.push(d[f](a, c));
            return b.apply(a, e)
          };
          return function () {
            return e
      ...
      function G() {
        ...
        return t(function (b, c) {
          for (var d = [
          ], e = 0; e < a.length; e++) d.push(a[e](b, c));
          return d
        }, {
          literal: !0,
          constant: b
      ...
      s = function (a, b) {
        ...
        return function (d, e) {
          for (var f = [
          ], j = b ? b(d, e)  : d, g = 0; g < c.length; g++) f.push(c[g](d, e));
          g = a(d, e, j) || q;
    ...
    function Tb(b, a) {
      ...
      if (a) e = d < 6 ? Vb(c[0], c[1], c[2], c[3], c[4])  : function (a, b) {
        var e = 0,
        j;
        do j = Vb(c[e++], c[e++], c[e++], c[e++], c[e++]) (a, b),
        b = p,
        a = j;
        while (e < d);
        return j
          ...
          return j = {
            resolve: function (a) {
              if (f) {
                ...
                h = g(a);
                c.length && b(function () {
                  for (var a, b = 0, d = c.length; b < d; b++) a = c[b],
                  h.then(a[0], a[1])
                })
              }
            },
      ...
      function Vc() {
        ...
        this.$get = [
          ...
          function (a, c, d, e, g, i, f) {
            function h(a, b, c) {
              for (var b = '^' + b.replace(/[-\/\\^$:*+?.()|[\]{}]/g, '\\$&') + '$', d = '', e = [
              ], f = {
              }, j = /\\([:*])(\w+)/g, g, i = 0; (g = j.exec(b)) !== null; ) {
                d += b.slice(i, g.index);
                switch (g[1]) {
                  case ':':
                    d += '([^\\/]*)';
              ...
              e.when(b).then(function () {
                if (b) {
                  ...
                  if (B(c = b.template)) H(c) && (c = c(b.params));
                   else if (B(c = b.templateUrl)) if (H(c) && (c = c(b.params)), B(c)) b.loadedTemplateUrl = c,
                  c = i.get(c, {
                    cache: f
                  }).then(function (a) {
                    return a.data
                  ...
                  do {
                    ...
                    do {
                      if (i = n.$$watchers) for (o = i.length; o--; ) try {
                        ...
                        a.fn(d, e === f ? d : e, n),
                        r < 5 && (p = 4 - r, x[p] || (x[p] = [
                        ]), v = H(a.exp) ? 'fn: ' + (a.exp.name || a.exp.toString())  : a.exp, v += '; newVal: ' + ha(d) + '; oldVal: ' + ha(e), x[p].push(v))
                      } catch (G) {
                        c(G)
                      }
                      if (!(i = n.$$childHead || n !== this && n.$$nextSibling)) for (; n !== this && !(i = n.$$nextSibling); ) n = n.$parent
                    } while (n = i);
                    if (z && !r--) throw h.$$phase = null,
        ...
        function Yc() {
          this.$get = [
            ...
            function (b, a) {
              ...
              d = N((/android (\d+)/.exec(I((b.navigator || {
              }).userAgent)) || [
              ]) [1]),
              e = a[0] || {
              },
          ...
          this.$get = [
            ...
            function (a, b, c, d, k, l) {
              ...
              function o(b, c, g) {
                ...
                if (n) if (p = n.get(s)) if (p.then) return p.then(h, h),
                p;
    ...
    function ac(b) {
      function a(a) {
        ...
        if (b = a.match(c)) {
          ...
          i = N(b[5] || 0) - i;
          f = N(b[6] || 0);
          b = Math.round(parseFloat('0.' + (b[7] || 0)) * 1000);
          h.call(a, g, i, f, b)
        }
        return a
      }
    ...
    function ob(b, a) {
      ...
      return aa(function (c, d, e) {
        function g(b) {
          if (a === !0 || c.$index % 2 === a) h && !ia(b, h) && i(h),
          f(b);
          h = V(b)
        }
        function i(a) {
    ...
    Z = N((/msie (\d+)/.exec(I(navigator.userAgent)) || [
    ]) [1]),
    w,
    ga,
    ka = [
        ...
        return {
          ...
          link: function (c, d, e, g) {
            ...
            c.$watch(e.ngSwitch || e.on, function (a) {
              for (var d = 0, l = j.length; d < l; d++) j[d].$destroy(),
              i.leave(h[d]);
              h = [
              ];
              j = [
              ];
              if (f = g.cases['!' + a] || g.cases['?']) c.$eval(e.change),
              n(f, function (a) {
                var d = c.$new();
                j.push(d);
            ...
            function k(e, f, g) {
              function i() {
                ...
                for (A = 0; B = z.length, A < B; A++) {
                  ...
                  }, d[k] = q, d = t(e, d) === t(e, y))  : d = q === n(e, y), s = s || d);
                  C = j(e, y);
                  C = C === p ? '' : C;
                  h.push({
                    id: t ? t(e, y)  : l ? z[A] : A,
